...
plan_subscription_change_instance = PlanSubscriptionChange.from_json(json)
# print the JSON string representation of the object
print(PlanSubscriptionChange.to_json())

# convert the object into a dict
plan_subscription_change_dict = plan_subscription_change_instance.to_dict()
# create an instance of PlanSubscriptionChange from a dict
plan_subscription_change_from_dict = PlanSubscriptionChange.from_dict(plan_subscription_change_dict)
```

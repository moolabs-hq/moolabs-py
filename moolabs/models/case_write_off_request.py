...
class CaseWriteOffRequest(BaseModel):
    """
    POST /cases/{id}/write-off — requires approval (D5).
    """ # noqa: E501
    reason: Annotated[str, Field(strict=True, max_length=500)]
    amount_micros: Optional[StrictInt] = Field(default=None, description="Partial write-off amount; null = full")
    __properties: ClassVar[List[str]] = ["reason", "amount_micros"]

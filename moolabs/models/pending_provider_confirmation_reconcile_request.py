...
class PendingProviderConfirmationReconcileRequest(BaseModel):
    """
    PendingProviderConfirmationReconcileRequest
    """ # noqa: E501
    max_records: Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]] = 100
    __properties: ClassVar[List[str]] = ["max_records"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max_records": obj.get("max_records") if obj.get("max_records") is not None else 100
        })
        return _obj

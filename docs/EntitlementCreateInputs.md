...
json = "{}"
# create an instance of EntitlementCreateInputs from a JSON string
entitlement_create_inputs_instance = EntitlementCreateInputs.from_json(json)
# print the JSON string representation of the object
print(EntitlementCreateInputs.to_json())

# convert the object into a dict
entitlement_create_inputs_dict = entitlement_create_inputs_instance.to_dict()
# create an instance of EntitlementCreateInputs from a dict
entitlement_create_inputs_from_dict = EntitlementCreateInputs.from_dict(entitlement_create_inputs_dict)
```

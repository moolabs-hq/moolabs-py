...
class BulkReplayRequest(BaseModel):
    ...
    max_count: Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]] = 100
    __properties: ClassVar[List[str]] = ["event_ids", "source", "max_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_count": obj.get("max_count") if obj.get("max_count") is not None else 100
        })
        return _obj

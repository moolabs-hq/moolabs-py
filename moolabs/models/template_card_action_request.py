...
class TemplateCardActionRequest(BaseModel):
    """
    TemplateCardActionRequest
    """ # noqa: E501
    action: StrictStr
    idempotency_key: StrictStr
    chat_session_id: Optional[StrictStr] = None
    confirmation: Optional[Dict[str, Any]] = None
    change_reason: Optional[StrictStr] = None
    preview_case_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["action", "idempotency_key", "chat_session_id", "confirmation", "change_reason", "preview_case_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "preview_case_id": obj.get("preview_case_id")
        })
        return _obj

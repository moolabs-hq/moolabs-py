...
class QuoteApprovalResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["quote_id", "tenant_id", "version", "status", "approval_required", "required_role", "approval_policy_version", "approval_basis_digest", "reasons", "approval_id"]

...
class RateBulkImportRequest(BaseModel):
    """
    RateBulkImportRequest
    """ # noqa: E501
    tenant_id: StrictStr
    rates: List[RateCatalogCreate]
    __properties: ClassVar[List[str]] = ["tenant_id", "rates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rates": [RateCatalogCreate.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj

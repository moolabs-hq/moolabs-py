...
class OptOutResponse(BaseModel):
    ...
    channel: StrictStr
    opt_out: Optional[StrictBool] = True
    message: StrictStr
    __properties: ClassVar[List[str]] = ["contact_id", "channel", "opt_out", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "opt_out": obj.get("opt_out") if obj.get("opt_out") is not None else True,

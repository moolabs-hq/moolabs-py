...
class NoteCreate(BaseModel):
    ...
    author: Annotated[str, Field(strict=True, max_length=255)]
    note_type: Optional[StrictStr] = Field(default='general', description="general, escalation, dispute, internal, customer_interaction")
    account_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["content", "author", "note_type", "account_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "note_type": obj.get("note_type") if obj.get("note_type") is not None else 'general',

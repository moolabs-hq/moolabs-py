...
class TieredPricingPayload(BaseModel):
    """
    TieredPricingPayload
    """ # noqa: E501
    mode: StrictStr
    tiers: List[PriceTierPayload]
    __properties: ClassVar[List[str]] = ["mode", "tiers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mode": obj.get("mode"),
            "tiers": [PriceTierPayload.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None
        })
        return _obj

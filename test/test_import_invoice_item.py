...
class TestImportInvoiceItem(unittest.TestCase):
    """ImportInvoiceItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportInvoiceItem:
        """Test ImportInvoiceItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportInvoiceItem`
        """
    ...
    def testImportInvoiceItem(self):
        """Test ImportInvoiceItem"""

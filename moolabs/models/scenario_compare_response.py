...
class ScenarioCompareResponse(BaseModel):
    ...
    """ # noqa: E501
    total_scenarios: StrictInt
    scenarios: List[ScenarioItem]
    __properties: ClassVar[List[str]] = ["total_scenarios", "scenarios"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total_scenarios": obj.get("total_scenarios"),
            "scenarios": [ScenarioItem.from_dict(_item) for _item in obj["scenarios"]] if obj.get("scenarios") is not None else None
        })
        return _obj

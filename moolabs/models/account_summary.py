...
class AccountSummary(BaseModel):
    ...
    default_currency_code: Optional[StrictStr] = 'USD'
    is_strategic: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["id", "customer_id", "legal_name", "billing_country_code", "default_currency_code", "is_strategic"]

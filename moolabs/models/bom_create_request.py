...
class BomCreateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tenant_id", "feature_key", "name", "description", "workflow_type", "components", "created_by"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "components": [BomComponentIn.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None,

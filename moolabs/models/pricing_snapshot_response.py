...
class PricingSnapshotResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "quote_id", "quote_version", "pricing_snapshot_id", "priced_output", "pricing_trace", "pricing_trace_digest", "source_versions", "currency", "subtotal_micros", "discount_micros", "total_micros"]

...
class ReplayDeadLetterRequest(BaseModel):
    ...
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, description="Optional tenant override")
    pool_id: Optional[StrictStr] = Field(default=None, description="Optional pool override")
    __properties: ClassVar[List[str]] = ["tenant_id", "pool_id"]

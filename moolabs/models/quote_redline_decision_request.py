...
class QuoteRedlineDecisionRequest(BaseModel):
    """
    QuoteRedlineDecisionRequest
    """ # noqa: E501
    decision_reason: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = None
    __properties: ClassVar[List[str]] = ["decision_reason"]

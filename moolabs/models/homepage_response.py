...
class HomepageResponse(BaseModel):
    ...
    greeting: StrictStr
    __properties: ClassVar[List[str]] = ["insights", "quick_actions", "greeting"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in quick_actions (list)
        _items = []
        if self.quick_actions:
            for _item_quick_actions in self.quick_actions:
                if _item_quick_actions:
                    _items.append(_item_quick_actions.to_dict())
            _dict['quick_actions'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "insights": [InsightCard.from_dict(_item) for _item in obj["insights"]] if obj.get("insights") is not None else None,
            "quick_actions": [QuickAction.from_dict(_item) for _item in obj["quick_actions"]] if obj.get("quick_actions") is not None else None,

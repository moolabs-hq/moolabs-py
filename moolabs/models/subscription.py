...
class Subscription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "metadata", "createdAt", "updatedAt", "deletedAt", "activeFrom", "activeTo", "annotations", "alignment", "status", "customerId", "plan", "currency", "billingCadence", "proRatingConfig", "billingAnchor", "commercialOverrides"]

...
class TestEscalateResponse(unittest.TestCase):
    """EscalateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EscalateResponse:
        """Test EscalateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EscalateResponse`
        """
        model = EscalateResponse()
        if include_optional:

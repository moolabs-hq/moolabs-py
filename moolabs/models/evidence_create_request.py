...
class EvidenceCreateRequest(BaseModel):
    ...
    source_table: Optional[StrictStr] = None
    source_id: Optional[StrictStr] = None
    summary: Optional[StrictStr] = None
    amount_micros: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    __properties: ClassVar[List[str]] = ["evidence_type", "source_table", "source_id", "summary", "amount_micros"]

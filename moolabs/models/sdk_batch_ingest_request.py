...
class SDKBatchIngestRequest(BaseModel):
    """
    SDKBatchIngestRequest
    """ # noqa: E501
    events: Annotated[List[SDKEvent], Field(max_length=5000)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [SDKEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj

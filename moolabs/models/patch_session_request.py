...
class PatchSessionRequest(BaseModel):
    ...
    line_items: Optional[Annotated[List[QuoteLineItemInput], Field(max_length=100)]] = None
    commercial_terms: Optional[Dict[str, Any]] = None
    credit_terms: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["scratchpad", "line_items", "commercial_terms", "credit_terms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scratchpad": obj.get("scratchpad"),
            "line_items": [QuoteLineItemInput.from_dict(_item) for _item in obj["line_items"]] if obj.get("line_items") is not None else None,

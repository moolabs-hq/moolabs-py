...
class TenantConfigResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tenant_id", "region", "endpoints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "endpoints": EndpointsResponse.from_dict(obj["endpoints"]) if obj.get("endpoints") is not None else None
        })
        return _obj

...
class AccountOverviewBucketResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bucket", "invoice_count", "total_amount_micros"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoice_count": obj.get("invoice_count"),

...
class OverrideRequest(BaseModel):
    ...
    completion_note: Optional[Annotated[str, Field(strict=True, max_length=2000)]] = None
    __properties: ClassVar[List[str]] = ["corrected_values", "completion_note"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "corrected_values": obj.get("corrected_values"),
            "completion_note": obj.get("completion_note")
        })
        return _obj

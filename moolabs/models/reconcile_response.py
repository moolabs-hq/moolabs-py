...
class ReconcileResponse(BaseModel):
    ...
    tenant_id: StrictStr
    status: StrictStr
    cost_event_ids_count: StrictInt
    message: StrictStr
    __properties: ClassVar[List[str]] = ["job_id", "tenant_id", "status", "cost_event_ids_count", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cost_event_ids_count": obj.get("cost_event_ids_count"),

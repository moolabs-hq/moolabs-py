...
class ReportCreateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["report_type", "format", "allow_empty", "filters", "source"]
    ...
    def source_validate_enum(cls, value):
        ...
        if value not in set(['ask_moo', 'api', 'scheduled', 'ui']):
            raise ValueError("must be one of enum values ('ask_moo', 'api', 'scheduled', 'ui')")
        return value

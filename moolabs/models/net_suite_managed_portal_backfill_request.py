...
class NetSuiteManagedPortalBackfillRequest(BaseModel):
    """
    NetSuiteManagedPortalBackfillRequest
    """ # noqa: E501
    dry_run: Optional[StrictBool] = True
    include_false: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["dry_run", "include_false"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "include_false": obj.get("include_false") if obj.get("include_false") is not None else False
        })
        return _obj

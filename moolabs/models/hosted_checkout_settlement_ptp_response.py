...
class HostedCheckoutSettlementPTPResponse(BaseModel):
    """
    ...
    fulfilled_amount_micros: StrictInt
    status: StrictStr
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "case_id", "invoice_id", "promised_amount_micros", "fulfilled_amount_micros", "status", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fulfilled_amount_micros": obj.get("fulfilled_amount_micros"),

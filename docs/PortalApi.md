...
------------- | ------------- | -------------
[**create_portal_token**](PortalApi.md#create_portal_token) | **POST** /api/v1/portal/tokens | Create consumer portal token
[**invalidate_portal_tokens**](PortalApi.md#invalidate_portal_tokens) | **POST** /api/v1/portal/tokens/invalidate | Invalidate portal tokens
[**list_portal_tokens**](PortalApi.md#list_portal_tokens) | **GET** /api/v1/portal/tokens | List consumer portal tokens
[**query_portal_meter**](PortalApi.md#query_portal_meter) | **GET** /api/v1/portal/meters/{meterSlug}/query | Query meter Query meter
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PortalApi->create_portal_token:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PortalApi->create_portal_token: %s\n" % e)
```
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PortalApi->invalidate_portal_tokens: %s\n" % e)
```
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PortalApi->list_portal_tokens:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PortalApi->list_portal_tokens: %s\n" % e)
```
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PortalApi->query_portal_meter:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PortalApi->query_portal_meter: %s\n" % e)
```

...
class ClauseCitations(BaseModel):
    """
    Citation references for a clause family.
    """ # noqa: E501
    market: Optional[List[StrictStr]] = None
    tenant_kb: Optional[List[StrictStr]] = None
    tenant_corpus: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["market", "tenant_kb", "tenant_corpus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tenant_kb": obj.get("tenant_kb"),
            "tenant_corpus": obj.get("tenant_corpus")
        })
        return _obj

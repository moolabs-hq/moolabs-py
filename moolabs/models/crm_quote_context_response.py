...
class CrmQuoteContextResponse(BaseModel):
    """
    ...
    record_id: StrictStr
    record_title: StrictStr
    record_summary: StrictStr
    crm_refs: Dict[str, StrictStr]
    source_uri: StrictStr
    source_evidence_id: StrictStr
    __properties: ClassVar[List[str]] = ["provider", "record_type", "record_id", "record_title", "record_summary", "crm_refs", "source_uri", "source_evidence_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "record_title": obj.get("record_title"),
            "record_summary": obj.get("record_summary"),
            "crm_refs": obj.get("crm_refs"),

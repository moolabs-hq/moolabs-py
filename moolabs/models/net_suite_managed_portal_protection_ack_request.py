...
class NetSuiteManagedPortalProtectionAckRequest(BaseModel):
    """
    NetSuiteManagedPortalProtectionAckRequest
    """ # noqa: E501
    note: Optional[StrictStr] = None
    exit_protection_mode: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["note", "exit_protection_mode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "note": obj.get("note"),
            "exit_protection_mode": obj.get("exit_protection_mode") if obj.get("exit_protection_mode") is not None else True
        })
        return _obj

...
class HomepageApi:
    ...
    @validate_call
    def get_homepage_insights(
        self,
        persona: Annotated[Optional[Persona], Field(description="User persona/role")] = None,
        ...
        :param persona: User persona/role
        ...
        _param = self._get_homepage_insights_serialize(
            persona=persona,
    ...
    @validate_call
    def get_homepage_insights_with_http_info(
        self,
        persona: Annotated[Optional[Persona], Field(description="User persona/role")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_homepage_insights_without_preload_content(
        self,
        persona: Annotated[Optional[Persona], Field(description="User persona/role")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_homepage_insights_serialize(
        self,
        persona,
        _request_auth,
        _content_type,
        ...
        if persona is not None:
            ...
            _query_params.append(('persona', persona.value))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/homepage/insights',

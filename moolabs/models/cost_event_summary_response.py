...
class CostEventSummaryResponse(BaseModel):
    """
    CostEventSummaryResponse
    """ # noqa: E501
    items: List[CostEventSummaryItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CostEventSummaryItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj

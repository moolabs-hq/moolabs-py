...
class FeatureFlagItem(BaseModel):
    ...
    id: StrictStr
    name: StrictStr
    tenant_override: StrictBool
    default_value: StrictBool
    enabled: StrictBool
    last_changed: StrictStr
    __properties: ClassVar[List[str]] = ["id", "name", "tenant_override", "default_value", "enabled", "last_changed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "tenant_override": obj.get("tenant_override"),

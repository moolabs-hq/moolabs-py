...
class PlanPricingSyncRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenant_id", "operation", "plan_id", "plan", "effective_at", "pricing_shape"]

    @field_validator('operation')
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['publish', 'archive']):
            raise ValueError("must be one of enum values ('publish', 'archive')")
        return value

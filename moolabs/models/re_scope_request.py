...
class ReScopeRequest(BaseModel):
    ...
    """ # noqa: E501
    add_invoice_ids: Optional[List[StrictStr]] = None
    remove_invoice_ids: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["add_invoice_ids", "remove_invoice_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "add_invoice_ids": obj.get("add_invoice_ids"),
            "remove_invoice_ids": obj.get("remove_invoice_ids")
        })
        return _obj

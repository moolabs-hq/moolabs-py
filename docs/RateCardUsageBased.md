...
rate_card_usage_based_instance = RateCardUsageBased.from_json(json)
# print the JSON string representation of the object
print(RateCardUsageBased.to_json())

# convert the object into a dict
rate_card_usage_based_dict = rate_card_usage_based_instance.to_dict()
# create an instance of RateCardUsageBased from a dict
rate_card_usage_based_from_dict = RateCardUsageBased.from_dict(rate_card_usage_based_dict)
```

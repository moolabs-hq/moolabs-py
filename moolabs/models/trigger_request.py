...
class TriggerRequest(BaseModel):
    ...
    TriggerRequest
    """ # noqa: E501
    is_bootstrap: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["is_bootstrap"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_bootstrap": obj.get("is_bootstrap") if obj.get("is_bootstrap") is not None else False
        })
        return _obj

...
class ComputeVarianceResponse(BaseModel):
    ...
    status: StrictStr
    variance: Optional[VarianceDecompositionOut] = None
    __properties: ClassVar[List[str]] = ["job_id", "tenant_id", "feature_key", "period_start", "period_end", "bom_template_id", "status", "variance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "variance": VarianceDecompositionOut.from_dict(obj["variance"]) if obj.get("variance") is not None else None
        })
        return _obj

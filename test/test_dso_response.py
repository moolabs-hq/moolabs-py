...
class TestDSOResponse(unittest.TestCase):
    """DSOResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DSOResponse:
        """Test DSOResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DSOResponse`
        """
        model = DSOResponse()
        if include_optional:
            return DSOResponse(

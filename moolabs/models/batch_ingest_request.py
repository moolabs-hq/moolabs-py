...
class BatchIngestRequest(BaseModel):
    ...
    BatchIngestRequest
    """ # noqa: E501
    events: Annotated[List[CostEventIngest], Field(max_length=5000)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [CostEventIngest.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj

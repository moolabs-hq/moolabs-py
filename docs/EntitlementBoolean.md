...
entitlement_boolean_instance = EntitlementBoolean.from_json(json)
# print the JSON string representation of the object
print(EntitlementBoolean.to_json())

# convert the object into a dict
entitlement_boolean_dict = entitlement_boolean_instance.to_dict()
# create an instance of EntitlementBoolean from a dict
entitlement_boolean_from_dict = EntitlementBoolean.from_dict(entitlement_boolean_dict)
```

...
class QuoteAgentProvenanceRunResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "tenant_id", "quote_id", "quote_version", "agent_name", "trust_tier", "surface", "actor_type", "actor_id", "status", "started_at", "completed_at", "rationale_summary", "error_code"]

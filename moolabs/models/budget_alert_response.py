...
class BudgetAlertResponse(BaseModel):
    ...
    tenant_id: StrictStr
    budget_id: StrictStr
    threshold_pct: StrictInt
    current_spend: StrictStr
    utilization_pct: StrictStr
    alert_action: StrictStr
    period_start: StrictStr
    period_end: StrictStr
    fired_at: StrictStr
    acknowledged_at: StrictStr
    __properties: ClassVar[List[str]] = ["id", "tenant_id", "budget_id", "threshold_pct", "current_spend", "utilization_pct", "alert_action", "period_start", "period_end", "fired_at", "acknowledged_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "threshold_pct": obj.get("threshold_pct"),

...
class ProviderReadinessResponse(BaseModel):
    ...
    payment_instructions_ready: StrictBool
    blocking_reasons: List[StrictStr]
    readiness_hash: StrictStr
    __properties: ClassVar[List[str]] = ["ready", "from_address", "verification_status", "payment_instructions_ready", "blocking_reasons", "readiness_hash"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payment_instructions_ready": obj.get("payment_instructions_ready"),
            "blocking_reasons": obj.get("blocking_reasons"),
            "readiness_hash": obj.get("readiness_hash")
        })
        return _obj

...
class SubscriptionExpanded(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "metadata", "createdAt", "updatedAt", "deletedAt", "activeFrom", "activeTo", "annotations", "status", "customerId", "plan", "currency", "billingCadence", "proRatingConfig", "billingAnchor", "commercialOverrides", "quoteOriginKey", "grantsStatus", "alignment", "phases"]

...
class GrantActivationRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenant_id", "subscription_id", "customer_id", "plan_id", "plan_version", "effective_at", "credit_config", "commercial_overrides", "entitlements", "subject_keys"]

...
class ImportDisputesRequest(BaseModel):
    """
    ImportDisputesRequest
    """ # noqa: E501
    disputes: Annotated[List[ImportDisputeItem], Field(max_length=1000)]
    __properties: ClassVar[List[str]] = ["disputes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "disputes": [ImportDisputeItem.from_dict(_item) for _item in obj["disputes"]] if obj.get("disputes") is not None else None
        })
        return _obj

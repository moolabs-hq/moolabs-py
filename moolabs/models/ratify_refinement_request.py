...
class RatifyRefinementRequest(BaseModel):
    """
    ...
    owner: StrictStr
    position_tier: Optional[StrictStr] = 'preferred'
    __properties: ClassVar[List[str]] = ["feedback_id", "industry_vertical", "owner", "position_tier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "owner": obj.get("owner"),
            "position_tier": obj.get("position_tier") if obj.get("position_tier") is not None else 'preferred'
        })
        return _obj

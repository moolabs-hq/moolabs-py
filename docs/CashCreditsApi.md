...
> object apply_credit_endpoint_v1(credit_id, x_api_key, apply_credit_request, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        # Apply Credit Endpoint
        api_response = api_instance.apply_credit_endpoint_v1(credit_id, x_api_key, apply_credit_request, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
> object convert_credit_endpoint_v1(credit_id, x_api_key, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        # Convert Credit Endpoint
        api_response = api_instance.convert_credit_endpoint_v1(credit_id, x_api_key, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
> object list_credits_endpoint_v1(x_api_key, account_id=account_id, status=status, page=page, page_size=page_size, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        # List Credits Endpoint
        api_response = api_instance.list_credits_endpoint_v1(x_api_key, account_id=account_id, status=status, page=page, page_size=page_size, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
> object refund_credit_endpoint_v1(credit_id, x_api_key, refund_credit_request, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        # Refund Credit Endpoint
        api_response = api_instance.refund_credit_endpoint_v1(credit_id, x_api_key, refund_credit_request, x_tenant_id=x_tenant_id, x_org_id=x_org_id)

...
class DealContext(BaseModel):
    ...
    """ # noqa: E501
    bind: Dict[str, StrictStr]
    rules: List[DealContextRule]
    __properties: ClassVar[List[str]] = ["bind", "rules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bind": obj.get("bind"),
            "rules": [DealContextRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj

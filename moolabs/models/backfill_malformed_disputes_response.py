...
class BackfillMalformedDisputesResponse(BaseModel):
    """
    BackfillMalformedDisputesResponse
    """ # noqa: E501
    scanned: StrictInt
    candidates: List[BackfillCandidate]
    soft_marked: StrictInt
    rerouted: StrictInt
    __properties: ClassVar[List[str]] = ["scanned", "candidates", "soft_marked", "rerouted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "candidates": [BackfillCandidate.from_dict(_item) for _item in obj["candidates"]] if obj.get("candidates") is not None else None,
            "soft_marked": obj.get("soft_marked"),
            "rerouted": obj.get("rerouted")
        })
        return _obj

...
class CostAdjustmentResponse(BaseModel):
    ...
    id: StrictStr
    tenant_id: StrictStr
    original_cost_event_id: StrictStr
    original_cost_event_timestamp: datetime
    adjustment_type: StrictStr
    adjustment_amount: StrictStr
    reason: StrictStr
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "tenant_id", "original_cost_event_id", "original_cost_event_timestamp", "adjustment_type", "adjustment_amount", "reason", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "adjustment_amount": obj.get("adjustment_amount"),

...
class ArcDunningTemplateAdminRevokeRequest(BaseModel):
    """
    ArcDunningTemplateAdminRevokeRequest
    """ # noqa: E501
    revoke_reason: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1000)]] = 'Revoked from ARC Communications Settings'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "revoke_reason": obj.get("revoke_reason") if obj.get("revoke_reason") is not None else 'Revoked from ARC Communications Settings'
        })
        return _obj

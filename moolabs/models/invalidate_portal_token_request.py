...
class InvalidatePortalTokenRequest(BaseModel):
    """
    Request to invalidate portal token(s).
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="Plaintext token to revoke")
    subject: Optional[StrictStr] = Field(default=None, description="Revoke all tokens for subject")
    __properties: ClassVar[List[str]] = ["token", "subject"]

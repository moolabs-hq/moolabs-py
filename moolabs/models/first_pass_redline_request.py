...
class FirstPassRedlineRequest(BaseModel):
    """
    Optional body for POST /quotes/{id}/redlines/first-pass.
    """ # noqa: E501
    industry_vertical: Optional[Annotated[str, Field(strict=True, max_length=64)]] = 'ai-saas'
    __properties: ClassVar[List[str]] = ["industry_vertical"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "industry_vertical": obj.get("industry_vertical") if obj.get("industry_vertical") is not None else 'ai-saas'
        })
        return _obj

...
class HeliconeConfigRequest(BaseModel):
    """
    HeliconeConfigRequest
    """ # noqa: E501
    api_key: Annotated[str, Field(min_length=1, strict=True)]
    webhook_secret: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    poll_interval_minutes: Optional[Annotated[int, Field(le=1440, strict=True, ge=1)]] = 5
    __properties: ClassVar[List[str]] = ["api_key", "webhook_secret", "poll_interval_minutes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "poll_interval_minutes": obj.get("poll_interval_minutes") if obj.get("poll_interval_minutes") is not None else 5
        })
        return _obj

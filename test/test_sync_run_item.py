...
class TestSyncRunItem(unittest.TestCase):
    """SyncRunItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncRunItem:
        """Test SyncRunItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncRunItem`
        """
        model = SyncRunItem()
        if include_optional:
            return SyncRunItem(

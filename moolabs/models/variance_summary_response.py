...
class VarianceSummaryResponse(BaseModel):
    ...
    items: List[VarianceDecompositionOut]
    total_items: StrictInt
    __properties: ClassVar[List[str]] = ["period_start", "period_end", "items", "total_items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [VarianceDecompositionOut.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,

...
class CustomerCostItem(BaseModel):
    """
    CustomerCostItem
    """ # noqa: E501
    ...
    avg_cost_per_request: Union[StrictFloat, StrictInt]
    top_model: StrictStr
    __properties: ClassVar[List[str]] = ["customer_id", "total_cost", "request_count", "avg_cost_per_request", "top_model"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "avg_cost_per_request": obj.get("avg_cost_per_request"),
            "top_model": obj.get("top_model")
        })
        return _obj

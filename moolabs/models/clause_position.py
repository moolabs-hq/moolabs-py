...
class ClausePosition(BaseModel):
    ...
    """ # noqa: E501
    criteria: StrictStr
    standard_language: Optional[StrictStr] = None
    rationale: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["criteria", "standard_language", "rationale"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "standard_language": obj.get("standard_language"),

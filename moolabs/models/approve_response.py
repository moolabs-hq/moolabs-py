...
class ApproveResponse(BaseModel):
    ...
    ApproveResponse
    """ # noqa: E501
    approval_event_id: StrictStr
    status: StrictStr
    completion_kind: StrictStr
    __properties: ClassVar[List[str]] = ["approval_event_id", "status", "completion_kind"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "approval_event_id": obj.get("approval_event_id"),

...
class PlanReference(BaseModel):
    ...
    """ # noqa: E501
    id: Annotated[str, Field(strict=True)] = Field(description="The plan ID.")
    key: Annotated[str, Field(min_length=1, strict=True, max_length=64)] = Field(description="The plan key.")
    version: StrictInt = Field(description="The plan version.")
    __properties: ClassVar[List[str]] = ["id", "key", "version"]

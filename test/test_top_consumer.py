...
class TestTopConsumer(unittest.TestCase):
    """TopConsumer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TopConsumer:
        """Test TopConsumer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TopConsumer`
        """
        model = TopConsumer()
        if include_optional:
            return TopConsumer(

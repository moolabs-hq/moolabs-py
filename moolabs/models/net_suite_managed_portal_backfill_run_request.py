...
class NetSuiteManagedPortalBackfillRunRequest(BaseModel):
    """
    NetSuiteManagedPortalBackfillRunRequest
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = None
    max_jobs: Optional[Annotated[int, Field(le=20, strict=True, ge=1)]] = 1
    __properties: ClassVar[List[str]] = ["tenant_id", "max_jobs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_jobs": obj.get("max_jobs") if obj.get("max_jobs") is not None else 1
        })
        return _obj

...
class TestChatMessageIn(unittest.TestCase):
    """ChatMessageIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatMessageIn:
        """Test ChatMessageIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatMessageIn`
        """
        model = ChatMessageIn()
        if include_optional:

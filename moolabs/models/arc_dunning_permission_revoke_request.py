...
class ArcDunningPermissionRevokeRequest(BaseModel):
    """
    ArcDunningPermissionRevokeRequest
    """ # noqa: E501
    revoke_reason: Annotated[str, Field(min_length=1, strict=True, max_length=1000)]
    idempotency_key: Optional[Annotated[str, Field(strict=True, max_length=255)]] = None
    __properties: ClassVar[List[str]] = ["revoke_reason", "idempotency_key"]

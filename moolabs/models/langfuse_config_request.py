...
class LangfuseConfigRequest(BaseModel):
    ...
    """ # noqa: E501
    public_key: Annotated[str, Field(min_length=1, strict=True)]
    secret_key: Annotated[str, Field(min_length=1, strict=True)]
    host: Optional[StrictStr] = 'https://cloud.langfuse.com'
    __properties: ClassVar[List[str]] = ["public_key", "secret_key", "host"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "host": obj.get("host") if obj.get("host") is not None else 'https://cloud.langfuse.com'
        })
        return _obj

...
class NotificationEventBalanceThresholdPayloadData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["entitlement", "feature", "subject", "value", "customer", "threshold"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "threshold": NotificationRuleBalanceThresholdValue.from_dict(obj["threshold"]) if obj.get("threshold") is not None else None
        })
        return _obj

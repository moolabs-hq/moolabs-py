...
class TestFeatureFlagItem(unittest.TestCase):
    """FeatureFlagItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureFlagItem:
        """Test FeatureFlagItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureFlagItem`
        """
        model = FeatureFlagItem()
        if include_optional:

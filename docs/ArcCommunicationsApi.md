...
> ApprovalActionResponse approve_communication(case_id, comm_id, x_api_key, x_tenant_id=x_tenant_id, x_org_id=x_org_id, approval_action_request=approval_action_request)
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        # Approve Communication
        api_response = api_instance.approve_communication(case_id, comm_id, x_api_key, x_tenant_id=x_tenant_id, x_org_id=x_org_id, approval_action_request=approval_action_request)
...
> CommunicationResponse create_communication(case_id, x_api_key, communication_create, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Communication
        api_response = api_instance.create_communication(case_id, x_api_key, communication_create, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
# **list_communications**
> CommunicationListResponse list_communications(case_id, x_api_key, page=page, page_size=page_size, direction=direction, channel=channel, status=status, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        # List Communications
        api_response = api_instance.list_communications(case_id, x_api_key, page=page, page_size=page_size, direction=direction, channel=channel, status=status, x_tenant_id=x_tenant_id, x_org_id=x_org_id)
...
> ApprovalActionResponse reject_communication(case_id, comm_id, x_api_key, x_tenant_id=x_tenant_id, x_org_id=x_org_id, approval_action_request=approval_action_request)
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        # Reject Communication
        api_response = api_instance.reject_communication(case_id, comm_id, x_api_key, x_tenant_id=x_tenant_id, x_org_id=x_org_id, approval_action_request=approval_action_request)
...
> ApprovalActionResponse resolve_provider_confirmation_v1_arc(case_id, comm_id, x_api_key, provider_confirmation_repair_request, x_tenant_id=x_tenant_id, x_org_id=x_org_id, x_user_id=x_user_id, x_arc_roles=x_arc_roles, x_arc_proxy_secret=x_arc_proxy_secret)
...
with moolabs.ApiClient(configuration) as api_client:
    ...
    try:
        # Resolve Provider Confirmation
        api_response = api_instance.resolve_provider_confirmation_v1_arc(case_id, comm_id, x_api_key, provider_confirmation_repair_request, x_tenant_id=x_tenant_id, x_org_id=x_org_id, x_user_id=x_user_id, x_arc_roles=x_arc_roles, x_arc_proxy_secret=x_arc_proxy_secret)

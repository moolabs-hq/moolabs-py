...
class ValidateTemplateResponse(BaseModel):
    ...
    render_context_summary: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["validation", "render_context_summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "render_context_summary": obj.get("render_context_summary")
        })
        return _obj

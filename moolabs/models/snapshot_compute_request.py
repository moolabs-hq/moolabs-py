...
class SnapshotComputeRequest(BaseModel):
    ...
    period_type: Optional[StrictStr] = 'daily'
    period_start: datetime
    period_end: datetime
    __properties: ClassVar[List[str]] = ["tenant_id", "period_type", "period_start", "period_end"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "period_type": obj.get("period_type") if obj.get("period_type") is not None else 'daily',

...
class TestRescheduleRequest(unittest.TestCase):
    """RescheduleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RescheduleRequest:
        """Test RescheduleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RescheduleRequest`
        """
        model = RescheduleRequest()
        if include_optional:
            return RescheduleRequest(
                new_due_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()
            )
        else:
            return RescheduleRequest(
                new_due_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
    ...
    def testRescheduleRequest(self):
        """Test RescheduleRequest"""

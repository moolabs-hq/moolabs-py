...
class BuyerRequestChangesRequest(BaseModel):
    """
    BuyerRequestChangesRequest
    """ # noqa: E501
    note: Annotated[str, Field(min_length=1, strict=True, max_length=1000)]
    requested_changes: Optional[BuyerRequestedChanges] = None
    __properties: ClassVar[List[str]] = ["note", "requested_changes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.requested_changes:
            _dict['requested_changes'] = self.requested_changes.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "note": obj.get("note"),
            "requested_changes": BuyerRequestedChanges.from_dict(obj["requested_changes"]) if obj.get("requested_changes") is not None else None
        })
        return _obj

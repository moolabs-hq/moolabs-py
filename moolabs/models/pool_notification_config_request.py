...
class PoolNotificationConfigRequest(BaseModel):
    """
    PoolNotificationConfigRequest
    """ # noqa: E501
    notification_emails: List[StrictStr] = Field(description="List of email addresses to notify on pool-level alerts")
    __properties: ClassVar[List[str]] = ["notification_emails"]

...
class TestComputeVarianceRequest(unittest.TestCase):
    """ComputeVarianceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComputeVarianceRequest:
        """Test ComputeVarianceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComputeVarianceRequest`
        """
        model = ComputeVarianceRequest()
        if include_optional:
            return ComputeVarianceRequest(
                tenant_id = '',
                feature_key = '',
    ...
    def testComputeVarianceRequest(self):
        """Test ComputeVarianceRequest"""

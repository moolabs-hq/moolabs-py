...
class AccountTeamMemberPatch(BaseModel):
    """
    ...
    """ # noqa: E501
    role: Optional[AccountTeamRole] = None
    ...
    notify_on_escalation: Optional[StrictBool] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notify_on_escalation": obj.get("notify_on_escalation")
        })
        return _obj

...
class SubscriptionAddonTimelineSegment(BaseModel):
    """
    ...
    quantity: Annotated[int, Field(strict=True, ge=0)] = Field(description="The quantity of the add-on for the given period.")
    __properties: ClassVar[List[str]] = ["activeFrom", "activeTo", "quantity"]

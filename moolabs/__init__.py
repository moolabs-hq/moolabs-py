...
from moolabs.exceptions import OpenApiException
from moolabs.exceptions import ApiTypeError
from moolabs.exceptions import ApiValueError
from moolabs.exceptions import ApiKeyError
from moolabs.exceptions import ApiAttributeError
from moolabs.exceptions import ApiException
...
"""Public exports appended to the generated package's __init__.py.

This file is concatenated onto ``moolabs/__init__.py`` by ``generate.sh``'s
DX-injection step (see ``sdks/generator/scripts/generate.sh:177-186``).
...
Customers see:
    ...
    from moolabs import (
        ...
        # pagination (C-SDK-3)
        Page,
        # webhook verification (R6 unchanged)
        WebhookVerifier,
    )

The 11 capability namespaces (usage, customers, catalog, subscriptions,
entitlements, wallets, credits, billing, collections, cost, notifications)
are NOT exported here — they're properties on the Moolabs client instance:
``client.billing``, etc.
"""

from ._dx_buffer import IngestBufferFull
...
from ._dx_pagination import Page
from ._dx_webhooks import WebhookVerifier

__all__ = [
    # Client
    "Moolabs",
    # Error hierarchy (frozen — contracts §3.6)
    "MoolabsError",
    "MoolabsAPIError",
    "AuthenticationError",
    "AuthorizationError",
    ...
    "RateLimitError",
    "RetryableError",
    # G5 buffer overflow exception (raise mode)
    "IngestBufferFull",
    # Pagination (contracts §3.4)
    "Page",
    # Webhook verification (R6 — unchanged from rc7)
    "WebhookVerifier",
]

...
class InboundEmailProcessResponse(BaseModel):
    """
    InboundEmailProcessResponse
    """ # noqa: E501
    inbound_message_id: StrictStr
    status: StrictStr
    created: StrictBool
    version: Optional[ContractVersionResponse] = None
    __properties: ClassVar[List[str]] = ["inbound_message_id", "status", "created", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "version": ContractVersionResponse.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
        return _obj

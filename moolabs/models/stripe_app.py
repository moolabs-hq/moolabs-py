...
class StripeApp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "metadata", "createdAt", "updatedAt", "deletedAt", "listing", "status", "type", "stripeAccountId", "livemode", "maskedAPIKey"]

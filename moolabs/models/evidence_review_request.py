...
class EvidenceReviewRequest(BaseModel):
    ...
    """ # noqa: E501
    resolution_status: StrictStr = Field(description="upheld, denied, or partial")
    resolved_amount_micros: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["resolution_status", "resolved_amount_micros"]

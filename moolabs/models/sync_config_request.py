...
class SyncConfigRequest(BaseModel):
    ...
    schedule: Optional[Annotated[str, Field(strict=True)]] = '0 6 * * *'
    __properties: ClassVar[List[str]] = ["cloud_provider", "schedule"]
    ...
    def schedule_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^([*0-9,-\/]+\s+){4}[*0-9,-\/]+$", value):
            raise ValueError(r"must validate the regular expression /^([*0-9,-\/]+\s+){4}[*0-9,-\/]+$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedule": obj.get("schedule") if obj.get("schedule") is not None else '0 6 * * *'
        })
        return _obj

...
class TestEscalateRequest(unittest.TestCase):
    """EscalateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EscalateRequest:
        """Test EscalateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EscalateRequest`
        """
        model = EscalateRequest()
        if include_optional:

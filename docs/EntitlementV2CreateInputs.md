...
json = "{}"
# create an instance of EntitlementV2CreateInputs from a JSON string
entitlement_v2_create_inputs_instance = EntitlementV2CreateInputs.from_json(json)
# print the JSON string representation of the object
print(EntitlementV2CreateInputs.to_json())

# convert the object into a dict
entitlement_v2_create_inputs_dict = entitlement_v2_create_inputs_instance.to_dict()
# create an instance of EntitlementV2CreateInputs from a dict
entitlement_v2_create_inputs_from_dict = EntitlementV2CreateInputs.from_dict(entitlement_v2_create_inputs_dict)
```

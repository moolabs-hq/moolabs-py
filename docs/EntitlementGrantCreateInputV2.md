...
json = "{}"
# create an instance of EntitlementGrantCreateInputV2 from a JSON string
entitlement_grant_create_input_v2_instance = EntitlementGrantCreateInputV2.from_json(json)
# print the JSON string representation of the object
print(EntitlementGrantCreateInputV2.to_json())

# convert the object into a dict
entitlement_grant_create_input_v2_dict = entitlement_grant_create_input_v2_instance.to_dict()
# create an instance of EntitlementGrantCreateInputV2 from a dict
entitlement_grant_create_input_v2_from_dict = EntitlementGrantCreateInputV2.from_dict(entitlement_grant_create_input_v2_dict)
```

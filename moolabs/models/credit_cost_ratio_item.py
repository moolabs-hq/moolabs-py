...
class CreditCostRatioItem(BaseModel):
    """
    CreditCostRatioItem
    """ # noqa: E501
    ...
    credit_cost_ratio: StrictStr
    __properties: ClassVar[List[str]] = ["date", "total_valued_burn", "total_cost", "credit_cost_ratio"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credit_cost_ratio": obj.get("credit_cost_ratio")
        })
        return _obj

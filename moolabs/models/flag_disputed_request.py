...
class FlagDisputedRequest(BaseModel):
    """
    ...
    dispute_type: Optional[StrictStr] = Field(default='admin', description="Dispute type for classification")
    __properties: ClassVar[List[str]] = ["disputed_amount_micros", "description", "dispute_type"]

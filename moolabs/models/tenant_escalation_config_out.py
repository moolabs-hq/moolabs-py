...
class TenantEscalationConfigOut(BaseModel):
    """
    ...
    has_overrides: StrictBool
    __properties: ClassVar[List[str]] = ["tenant_id", "config", "effective_config", "updated_by_user_id", "change_reason", "has_overrides"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "effective_config": obj.get("effective_config"),

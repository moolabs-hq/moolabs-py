...
class ResolveUnappliedRequest(BaseModel):
    """
    ResolveUnappliedRequest
    """ # noqa: E501
    disposition: StrictStr = Field(description="One of: applied_as_credit, refunded, abandoned_property, operational_void, de_minimis_writeoff, reversal_return")

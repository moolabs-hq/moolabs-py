...
class ComputeVarianceRequest(BaseModel):
    ...
    period_end: datetime
    bom_template_id: StrictStr = Field(description="BOM template UUID")
    __properties: ClassVar[List[str]] = ["tenant_id", "feature_key", "period_start", "period_end", "bom_template_id"]

...
class ImportInvoicesRequest(BaseModel):
    ...
    """ # noqa: E501
    invoices: Annotated[List[ImportInvoiceItem], Field(max_length=1000)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices": [ImportInvoiceItem.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj

...
class ContractUploadDetailResponse(BaseModel):
    """
    ...
    segments: List[ContractSegmentResponse]
    __properties: ClassVar[List[str]] = ["id", "filename", "page_count", "extracted_text", "segments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "segments": [ContractSegmentResponse.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None
        })
        return _obj

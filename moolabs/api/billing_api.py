...
class BillingApi:
    ...
    def retry_remediation_event(
        ...
        _param = self._retry_remediation_event_serialize(
    ...
    @validate_call
    def retry_remediation_event_with_http_info(
        self,
        usage_event_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def retry_remediation_event_without_preload_content(
        self,
        usage_event_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _retry_remediation_event_serialize(
        self,
        usage_event_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/billing/remediation/events/{usage_event_id}/retry',

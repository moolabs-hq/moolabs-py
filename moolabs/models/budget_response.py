...
class BudgetResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "tenant_id", "budget_name", "scope_type", "scope_id", "period_type", "budget_amount", "currency", "alert_thresholds", "notify_channels", "is_active", "created_by", "created_at", "updated_at"]

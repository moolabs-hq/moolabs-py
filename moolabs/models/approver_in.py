...
class ApproverIn(BaseModel):
    ...
    manager_user_ref: Optional[StrictStr] = None
    territory_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["level_key", "display_name", "manager_user_ref", "territory_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "level_key": obj.get("level_key"),
            "display_name": obj.get("display_name"),
            "manager_user_ref": obj.get("manager_user_ref"),
            "territory_key": obj.get("territory_key")
        })
        return _obj

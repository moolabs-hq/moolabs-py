...
class ApproveRequest(BaseModel):
    ...
    ApproveRequest
    """ # noqa: E501
    approval_note: Optional[Annotated[str, Field(strict=True, max_length=2000)]] = None
    __properties: ClassVar[List[str]] = ["approval_note"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "approval_note": obj.get("approval_note")
        })
        return _obj

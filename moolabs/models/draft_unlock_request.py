...
class DraftUnlockRequest(BaseModel):
    """
    DraftUnlockRequest
    """ # noqa: E501
    lock_id: Annotated[str, Field(min_length=1, strict=True)]
    lock_token: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["lock_id", "lock_token"]

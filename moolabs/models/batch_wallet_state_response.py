...
class BatchWalletStateResponse(BaseModel):
    """
    Batch wallet state response.
    """ # noqa: E501
    states: List[WalletStateResponse] = Field(description="List of wallet states")
    errors: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of errors for wallets that failed")
    __properties: ClassVar[List[str]] = ["states", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "states": [WalletStateResponse.from_dict(_item) for _item in obj["states"]] if obj.get("states") is not None else None,

...
class TerritoryIn(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    parent_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "parent_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TerritoryIn from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TerritoryIn from a dict"""
        if obj is None:
            return None

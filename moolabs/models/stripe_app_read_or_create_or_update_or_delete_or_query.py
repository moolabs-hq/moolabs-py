...
class StripeAppReadOrCreateOrUpdateOrDeleteOrQuery(BaseModel):
    """
    ...
    type: StrictStr = Field(description="The app's type is Stripe.")
    stripe_account_id: StrictStr = Field(description="The Stripe account ID.", alias="stripeAccountId")
    livemode: StrictBool = Field(description="Livemode, true if the app is in production mode.")
    masked_api_key: StrictStr = Field(description="The masked API key. Only shows the first 8 and last 3 characters.", alias="maskedAPIKey")
    secret_api_key: Optional[SecretStr] = Field(default=None, description="The Stripe API key.", alias="secretAPIKey")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "metadata", "createdAt", "updatedAt", "deletedAt", "listing", "status", "type", "stripeAccountId", "livemode", "maskedAPIKey", "secretAPIKey"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "stripeAccountId": obj.get("stripeAccountId"),
            "livemode": obj.get("livemode"),
            "maskedAPIKey": obj.get("maskedAPIKey"),
            "secretAPIKey": obj.get("secretAPIKey")
        })
        return _obj

...
class TestCustomInvoicingApp(unittest.TestCase):
    """CustomInvoicingApp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomInvoicingApp:
        """Test CustomInvoicingApp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomInvoicingApp`
        """
        model = CustomInvoicingApp()
        if include_optional:
            return CustomInvoicingApp(
    ...
    def testCustomInvoicingApp(self):
        """Test CustomInvoicingApp"""

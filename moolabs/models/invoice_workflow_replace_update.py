...
class InvoiceWorkflowReplaceUpdate(BaseModel):
    """
    ...
    """ # noqa: E501
    workflow: InvoiceWorkflowSettingsReplaceUpdate = Field(description="The workflow used for this invoice.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workflow": InvoiceWorkflowSettingsReplaceUpdate.from_dict(obj["workflow"]) if obj.get("workflow") is not None else None
        })
        return _obj

...
class ContactResponse(BaseModel):
    ...
    role: StrictStr
    is_primary_ap: StrictBool
    is_active: StrictBool
    email_verified_at: Optional[datetime] = None
    phone_verified_at: Optional[datetime] = None
    verification_source: Optional[StrictStr] = None
    locale: Optional[StrictStr] = None
    timezone: Optional[StrictStr] = None
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "tenant_id", "account_id", "full_name", "email", "phone", "role", "is_primary_ap", "is_active", "email_verified_at", "phone_verified_at", "verification_source", "locale", "timezone", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "phone": obj.get("phone"),
            "role": obj.get("role"),
            "is_primary_ap": obj.get("is_primary_ap"),
            "is_active": obj.get("is_active"),
            "email_verified_at": obj.get("email_verified_at"),
            "phone_verified_at": obj.get("phone_verified_at"),

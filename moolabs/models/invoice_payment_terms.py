...
class InvoicePaymentTerms(BaseModel):
    ...
    """ # noqa: E501
    terms: Optional[PaymentTerms] = Field(default=None, description="The terms of payment for the invoice.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "terms": PaymentTerms.from_dict(obj["terms"]) if obj.get("terms") is not None else None
        })
        return _obj

...
class ChannelPreferenceUpdate(BaseModel):
    ...
    """ # noqa: E501
    preferences: List[ChannelPreferenceCreate]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "preferences": [ChannelPreferenceCreate.from_dict(_item) for _item in obj["preferences"]] if obj.get("preferences") is not None else None
        })
        return _obj

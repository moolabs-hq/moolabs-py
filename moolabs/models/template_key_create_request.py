...
class TemplateKeyCreateRequest(BaseModel):
    """
    TemplateKeyCreateRequest
    """ # noqa: E501
    canonical_template_key: Annotated[str, Field(min_length=3, strict=True, max_length=100)]
    ...
    __properties: ClassVar[List[str]] = ["canonical_template_key", "display_name", "change_reason"]

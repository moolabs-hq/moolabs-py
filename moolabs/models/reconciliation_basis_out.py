...
class ReconciliationBasisOut(BaseModel):
    """
    ReconciliationBasisOut
    """ # noqa: E501
    grade: StrictStr
    data_freshness: StrictStr
    cost_completeness_pct: Union[StrictFloat, StrictInt]
    observation_status: StrictStr
    bom_approved_at: StrictStr
    __properties: ClassVar[List[str]] = ["grade", "data_freshness", "cost_completeness_pct", "observation_status", "bom_approved_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cost_completeness_pct": obj.get("cost_completeness_pct"),
            "observation_status": obj.get("observation_status"),
            "bom_approved_at": obj.get("bom_approved_at")
        })
        return _obj

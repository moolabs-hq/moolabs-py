...
class CostEventSummaryRequest(BaseModel):
    """
    CostEventSummaryRequest
    """ # noqa: E501
    usage_event_ids: Annotated[List[StrictStr], Field(min_length=1, max_length=100)]
    __properties: ClassVar[List[str]] = ["usage_event_ids"]

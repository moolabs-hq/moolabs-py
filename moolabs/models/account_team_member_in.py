...
class AccountTeamMemberIn(BaseModel):
    """
    ...
    notify_on_escalation: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["role", "name", "email", "is_primary", "notify_on_escalation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notify_on_escalation": obj.get("notify_on_escalation") if obj.get("notify_on_escalation") is not None else True
        })
        return _obj

...
class PolicyUpdateRequest(BaseModel):
    ...
    PolicyUpdateRequest
    """ # noqa: E501
    max_autonomy: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = None
    allowed_actions: Optional[Dict[str, Any]] = None
    requires_human_for: Optional[Dict[str, Any]] = None
    policy_version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["max_autonomy", "allowed_actions", "requires_human_for", "policy_version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requires_human_for": obj.get("requires_human_for"),

...
**invoice_count** | **int** |  | [optional] [default to 0]
...
case_list_item_response_instance = CaseListItemResponse.from_json(json)
# print the JSON string representation of the object
print(CaseListItemResponse.to_json())

# convert the object into a dict
case_list_item_response_dict = case_list_item_response_instance.to_dict()
# create an instance of CaseListItemResponse from a dict
case_list_item_response_from_dict = CaseListItemResponse.from_dict(case_list_item_response_dict)
```

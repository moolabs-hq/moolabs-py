...
class TemplateMetaResponse(BaseModel):
    ...
    """ # noqa: E501
    render_syntax: StrictStr
    template_ids: List[StrictStr]
    context_contract: Dict[str, Any]
    template_names: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["render_syntax", "template_ids", "context_contract", "template_names"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "render_syntax": obj.get("render_syntax"),
            "template_ids": obj.get("template_ids"),
            "context_contract": obj.get("context_contract"),
            "template_names": obj.get("template_names")
        })
        return _obj

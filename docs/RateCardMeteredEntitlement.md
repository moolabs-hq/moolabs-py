...
rate_card_metered_entitlement_instance = RateCardMeteredEntitlement.from_json(json)
# print the JSON string representation of the object
print(RateCardMeteredEntitlement.to_json())

# convert the object into a dict
rate_card_metered_entitlement_dict = rate_card_metered_entitlement_instance.to_dict()
# create an instance of RateCardMeteredEntitlement from a dict
rate_card_metered_entitlement_from_dict = RateCardMeteredEntitlement.from_dict(rate_card_metered_entitlement_dict)
```

...
class FeatureCostItem(BaseModel):
    ...
    total_quantity: Union[StrictFloat, StrictInt]
    event_count: StrictInt
    avg_cost: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["feature_key", "total_cost", "total_quantity", "event_count", "avg_cost"]

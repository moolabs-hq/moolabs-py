...
class TestTestSendResponse(unittest.TestCase):
    """TestSendResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestSendResponse:
        """Test TestSendResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestSendResponse`
        """
        model = TestSendResponse()
        if include_optional:

...
json = "{}"
# create an instance of NotificationRuleEntitlementReset from a JSON string
notification_rule_entitlement_reset_instance = NotificationRuleEntitlementReset.from_json(json)
# print the JSON string representation of the object
print(NotificationRuleEntitlementReset.to_json())

# convert the object into a dict
notification_rule_entitlement_reset_dict = notification_rule_entitlement_reset_instance.to_dict()
# create an instance of NotificationRuleEntitlementReset from a dict
notification_rule_entitlement_reset_from_dict = NotificationRuleEntitlementReset.from_dict(notification_rule_entitlement_reset_dict)
```

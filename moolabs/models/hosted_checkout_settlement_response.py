...
class HostedCheckoutSettlementResponse(BaseModel):
    """
    Hosted checkout settlement response.
    """ # noqa: E501
    payment: PaymentResponse
    ptp: HostedCheckoutSettlementPTPResponse
    __properties: ClassVar[List[str]] = ["payment", "ptp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ptp": HostedCheckoutSettlementPTPResponse.from_dict(obj["ptp"]) if obj.get("ptp") is not None else None
        })
        return _obj

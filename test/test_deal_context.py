...
class TestDealContext(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DealContext:
        """Test DealContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealContext`
        """
        model = DealContext()
        if include_optional:
            return DealContext(

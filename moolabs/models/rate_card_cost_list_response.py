...
class RateCardCostListResponse(BaseModel):
    """
    RateCardCostListResponse
    """ # noqa: E501
    rate_cards: List[RateCardCostRow]
    __properties: ClassVar[List[str]] = ["rate_cards"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rate_cards": [RateCardCostRow.from_dict(_item) for _item in obj["rate_cards"]] if obj.get("rate_cards") is not None else None
        })
        return _obj

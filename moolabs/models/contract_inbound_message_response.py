...
class ContractInboundMessageResponse(BaseModel):
    """
    ...
    status: StrictStr
    quarantine_reason: Optional[StrictStr] = None
    safe_metadata: Dict[str, Any]
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "tenant_id", "thread_id", "provider_message_id", "from_email", "subject", "status", "quarantine_reason", "safe_metadata", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quarantine_reason": obj.get("quarantine_reason"),

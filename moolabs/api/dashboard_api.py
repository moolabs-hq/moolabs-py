...
class DashboardApi:
    ...
    def clerk_webhook(
        ...
        _param = self._clerk_webhook_serialize(
    ...
    @validate_call
    def clerk_webhook_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def clerk_webhook_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _clerk_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/webhooks/clerk',
    ...
    def netsuite_webhook(
        ...
        _param = self._netsuite_webhook_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def netsuite_webhook_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def netsuite_webhook_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _netsuite_webhook_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/webhooks/netsuite',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _stripe_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/webhooks/stripe',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

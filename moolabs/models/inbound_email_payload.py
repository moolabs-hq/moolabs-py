...
class InboundEmailPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["recipient", "from_email", "message_id", "subject", "attachments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attachments": [InboundEmailAttachment.from_dict(_item) for _item in obj["attachments"]] if obj.get("attachments") is not None else None
        })
        return _obj

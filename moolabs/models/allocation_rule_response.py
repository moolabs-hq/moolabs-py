...
class AllocationRuleResponse(BaseModel):
    ...
    allocation_keys: List[Any]
    amortization_months: StrictInt
    is_active: StrictBool
    priority: StrictInt
    created_by: StrictStr
    created_at: StrictStr
    updated_at: StrictStr
    __properties: ClassVar[List[str]] = ["id", "tenant_id", "name", "description", "rule_type", "source_filter", "target_type", "allocation_keys", "amortization_months", "is_active", "priority", "created_by", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allocation_keys": obj.get("allocation_keys"),

...
class OpsApi:
    ...
    def deep_health_check(
        self,
        x_metrics_token: Optional[StrictStr] = None,
        ...
        :param x_metrics_token:
        :type x_metrics_token: str
        ...
        _param = self._deep_health_check_serialize(
            x_metrics_token=x_metrics_token,
    ...
    @validate_call
    def deep_health_check_with_http_info(
        self,
        x_metrics_token: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def deep_health_check_without_preload_content(
        self,
        x_metrics_token: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _deep_health_check_serialize(
        self,
        x_metrics_token,
        _request_auth,
        _content_type,
        ...
        if x_metrics_token is not None:
            _header_params['X-Metrics-Token'] = x_metrics_token

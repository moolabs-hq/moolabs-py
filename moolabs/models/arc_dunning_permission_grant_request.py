...
class ArcDunningPermissionGrantRequest(BaseModel):
    """
    ArcDunningPermissionGrantRequest
    """ # noqa: E501
    tenant_id: StrictStr
    org_id: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    user_subject: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    grant_reason: Annotated[str, Field(min_length=1, strict=True, max_length=1000)]
    idempotency_key: Optional[Annotated[str, Field(strict=True, max_length=255)]] = None
    __properties: ClassVar[List[str]] = ["tenant_id", "org_id", "user_subject", "grant_reason", "idempotency_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "grant_reason": obj.get("grant_reason"),

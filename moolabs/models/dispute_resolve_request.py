...
class DisputeResolveRequest(BaseModel):
    ...
    """ # noqa: E501
    resolution: StrictStr = Field(description="resolved_valid or resolved_invalid")
    resolved_amount_micros: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    resolution_notes: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["resolution", "resolved_amount_micros", "resolution_notes"]

...
class AcuteHTTPValidationError(BaseModel):
    """
    AcuteHTTPValidationError
    """ # noqa: E501
    detail: Optional[List[AcuteValidationError]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detail": [AcuteValidationError.from_dict(_item) for _item in obj["detail"]] if obj.get("detail") is not None else None
        })
        return _obj

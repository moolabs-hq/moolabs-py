...
class ScenarioRequest(BaseModel):
    ...
    ScenarioRequest
    """ # noqa: E501
    scenarios: Annotated[List[SimulateMarginRequest], Field(min_length=1)] = Field(description="List of simulation scenarios for side-by-side comparison")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scenarios": [SimulateMarginRequest.from_dict(_item) for _item in obj["scenarios"]] if obj.get("scenarios") is not None else None
        })
        return _obj

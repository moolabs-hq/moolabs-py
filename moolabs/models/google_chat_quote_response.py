...
class GoogleChatQuoteResponse(BaseModel):
    """
    GoogleChatQuoteResponse
    """ # noqa: E501
    text: StrictStr
    cards_v2: Optional[List[Dict[str, Any]]] = Field(default=None, alias="cardsV2")
    __properties: ClassVar[List[str]] = ["text", "cardsV2"]

...
------------ | ------------- | ------------- | -------------
**namespace_id** | **str** | ULID (Universally Unique Lexicographically Sortable Identifier). | 
**app_id** | **str** | ULID (Universally Unique Lexicographically Sortable Identifier). | 
**customer_id** | **str** | ULID (Universally Unique Lexicographically Sortable Identifier). | [optional] 

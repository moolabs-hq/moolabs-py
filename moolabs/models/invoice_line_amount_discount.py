...
class InvoiceLineAmountDiscount(BaseModel):
    """
    ...
    amount: Annotated[str, Field(strict=True)] = Field(description="Fixed discount amount to apply (calculated if percent present).")
    __properties: ClassVar[List[str]] = ["createdAt", "updatedAt", "deletedAt", "id", "reason", "description", "externalIds", "amount"]

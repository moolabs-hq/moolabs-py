...
class BulkActionRequest(BaseModel):
    ...
    BulkActionRequest
    """ # noqa: E501
    action: StrictStr = Field(description="Action: pause, resume, escalate, assign")
    case_ids: Annotated[List[StrictStr], Field(min_length=1, max_length=500)]
    params: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["action", "case_ids", "params"]

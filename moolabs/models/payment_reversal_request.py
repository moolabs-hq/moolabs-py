...
class PaymentReversalRequest(BaseModel):
    ...
    """ # noqa: E501
    reversal_type: Optional[StrictStr] = Field(default='correction', description="chargeback, nsf, ach_return, refund, correction")
    reason: Optional[Annotated[str, Field(strict=True, max_length=500)]] = None
    __properties: ClassVar[List[str]] = ["reversal_type", "reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reversal_type": obj.get("reversal_type") if obj.get("reversal_type") is not None else 'correction',

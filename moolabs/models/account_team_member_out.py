...
class AccountTeamMemberOut(BaseModel):
    """
    ...
    notify_on_escalation: StrictBool
    __properties: ClassVar[List[str]] = ["id", "account_id", "role", "name", "email", "user_id", "is_primary", "notify_on_escalation"]

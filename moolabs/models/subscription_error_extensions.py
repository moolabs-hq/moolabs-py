...
class SubscriptionErrorExtensions(BaseModel):
    """
    Error extensions for the Subscription Errors.
    """ # noqa: E501
    validation_errors: List[ErrorExtension] = Field(alias="validationErrors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validationErrors": [ErrorExtension.from_dict(_item) for _item in obj["validationErrors"]] if obj.get("validationErrors") is not None else None
        })
        return _obj

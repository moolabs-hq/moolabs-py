...
class ReallocateResponse(BaseModel):
    ...
    allocations_created: StrictInt
    message: StrictStr
    __properties: ClassVar[List[str]] = ["rule_id", "tenant_id", "period_start", "period_end", "allocations_created", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allocations_created": obj.get("allocations_created"),

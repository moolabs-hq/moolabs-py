...
class HandoffCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    handoff_type: StrictStr
    partner_name: StrictStr
    commission_bps: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["handoff_type", "partner_name", "commission_bps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "handoff_type": obj.get("handoff_type"),
            "partner_name": obj.get("partner_name"),
            "commission_bps": obj.get("commission_bps")
        })
        return _obj
